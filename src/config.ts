...
export const siteConfig: SiteConfig = {
	title: "ChitandaEru",
	subtitle: "一个正在学习ai的小程序员",
	siteURL: "https://test1-c7v3.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-08-16", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	bilibili: {
		vmid: "bili_51363776631", // 在此处设置你的Bilibili用户ID (uid)，例如 "1129280784"
	...
	banner: {
		...
		homeText: {
			...
			title: "zcc的世界", // 主页横幅主标题

			subtitle: [
				"没有什么特别的事，但只要有你就足够",
				"不知不觉间，你已经成为了我生活的一部分",
				"和你聊天，平凡的日子也会变得些许快乐",
				"今天本是平平无奇的一天，却又有一点点美好",
				"今晚月色真美",
			],
			typewriter: {
	...
	links: [
		{
			name: "Bilibili",
			icon: "fa7-brands:bilibili",
			url: "https://space.bilibili.com/1008221010?spm_id_from=333.1007.0.0",
		},
		{
			name: "Gitee",
			icon: "mdi:git",
			url: "https://gitee.com/chitandaeru1314",
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/Chitandaeru486",
		},
	],
};
...
export const announcementConfig: AnnouncementConfig = {
	...
	content: "月が綺麗です。ようこそ、この小さなブログへ🌙", // 公告内容
